...
export const SearchBar = ({ onSearch, isLoading = false }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="relative w-full max-w-xs sm:max-w-md md:max-w-2xl lg:max-w-3xl mx-auto">
      <div className="relative">
        <Search className="absolute left-2 sm:left-3 md:left-4 lg:left-5 top-1/2 transform -translate-y-1/2 text-gray-400 h-4 w-4 sm:h-5 sm:w-5 md:h-6 md:w-6" />
        <input
          type="text"
          value={query}
