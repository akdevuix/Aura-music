  ...
  if (playlist.length === 0) {
    return (
      <div className="text-center py-12 sm:py-16 lg:py-20">
        ...
        <h2 className="text-xl sm:text-2xl font-semibold text-white mb-2 px-4">Your Playlist is Empty</h2>
        <p className="text-gray-400 text-sm sm:text-base lg:text-lg max-w-md mx-auto px-4">
